...
namespace Sounds {
    ...
    const uint16_t Theme[] PROGMEM = {
        NOTE_D6,461, NOTE_C6,461, NOTE_D6,461, NOTE_F6,230, NOTE_G6,230, NOTE_D6,461, NOTE_C6,461, NOTE_D6,461,
        NOTE_F6,230, NOTE_G6,230, NOTE_DS6,461, NOTE_D6,461, NOTE_DS6,461, NOTE_F6,230, NOTE_G6,230, NOTE_A5,461,
        NOTE_G5,461, NOTE_A5,461, NOTE_AS5,230, NOTE_C6,230,
        TONES_REPEAT
    };
